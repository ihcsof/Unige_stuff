/*
MAIN DEL PROGRAMMA DI AUTO-TESTING 2-02
...
!!! NON utilizzare USE HASH_TABLE per compilare questo specifico programma (excelMain2)
g++ excelMain2.cpp dictionary-hashtable.cpp string-utility.cpp excelAux.cpp dictionary-orderedvector.cpp dictionary-doublylinkedlist.cpp 
...
int main()
{
   ...
   double duration;
	...
	for(int i = 3; i < 12; ++i) {
		tableDim = dims[i%3];
		excelFile << "Test" << i << ": hash table con dim " << tableDim << " h" << i/3 << ",";
